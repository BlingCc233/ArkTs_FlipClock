...
const int32_t STRING_AND = 0x01000045;
const int32_t STRING_APP_NAME = 0x01000001;
const int32_t STRING_BOTTOM_TITLE_HEIGHT = 0x01000046;
const int32_t STRING_BUTTON_TEXT_COLOR = 0x01000047;
const int32_t STRING_CARD_SWIPER_FULL_SIZE = 0x01000048;
const int32_t STRING_CARD_SWIPER_PHOTO_PREVIEW_WIDTH = 0x01000049;
const int32_t STRING_CARD_SWIPER_TABLET_PREVIEW_WIDTH = 0x0100004a;
const int32_t STRING_CLICK_TO_LISTEN = 0x0100004b;
...
const int32_t STRING_DELETE_BACK = 0x01000053;
const int32_t STRING_DELETE_OK = 0x01000054;
const int32_t STRING_DESTINATION_DATA_1 = 0x01000055;
const int32_t STRING_DESTINATION_DATA_2 = 0x01000056;
const int32_t STRING_DIGITAL_SCROLL_ANIMATION_COMMA = 0x01000057;
const int32_t STRING_DIGITAL_SCROLL_ANIMATION_GET_TICKET = 0x01000058;
const int32_t STRING_DIGITAL_SCROLL_ANIMATION_TICKET = 0x01000059;
const int32_t STRING_DIGITAL_SCROLL_ANIMATION_TODAY = 0x0100005a;
const int32_t STRING_DIVIDER_HEIGHT = 0x0100005b;
const int32_t STRING_ENTRY_DESC = 0x0100005c;
const int32_t STRING_FIRST_PROMPT = 0x0100005d;
const int32_t STRING_FIVE_FR = 0x0100005e;
const int32_t STRING_FRIENDMOMENTSPAGE_MESSAGE = 0x0100005f;
const int32_t STRING_FRIENDMOMENTSPAGE_SHARE = 0x01000060;
const int32_t STRING_FRIENDS_CIRCLE_LIKES = 0x01000061;
const int32_t STRING_FULL_SIZE = 0x01000062;
const int32_t STRING_FUNCTION_TOOL_BAR = 0x01000063;
const int32_t STRING_IS_LISTENING = 0x01000064;
const int32_t STRING_JUMP_TEXT_ONE = 0x01000065;
const int32_t STRING_JUMP_TO_HISTORY = 0x01000066;
const int32_t STRING_JUMP_TO_TOP = 0x01000067;
const int32_t STRING_LOGIN_IN = 0x01000068;
const int32_t STRING_LOGIN_TEXT = 0x01000069;
...
const int32_t STRING_MAIN_PAGE_TOP_BORDERRADIUS = 0x0100006f;
const int32_t STRING_MARQUEE_CONTENT = 0x01000070;
const int32_t STRING_MARQUEE_TITLE = 0x01000071;
const int32_t STRING_MAX_SIZE = 0x01000072;
const int32_t STRING_MEMO_COUNTS = 0x01000073;
const int32_t STRING_MEMO_TITLE = 0x01000074;
const int32_t STRING_MODULE_DESC = 0x01000004;
const int32_t STRING_MY_TRIP = 0x01000075;
const int32_t STRING_NAME_PAGE_FOUR = 0x01000076;
const int32_t STRING_NAME_PAGE_ONE = 0x01000077;
const int32_t STRING_NAME_PAGE_THREE = 0x01000078;
const int32_t STRING_NAME_PAGE_TWO = 0x01000079;
const int32_t STRING_NEAR_MESSAGE = 0x0100007a;
...
const int32_t STRING_ORIGIN_DATA = 0x01000088;
const int32_t STRING_OTHER_LOGIN_METHODS = 0x01000089;
const int32_t STRING_PAGE_SHOW = 0x0100008a;
const int32_t STRING_PHONE_NUMBER = 0x0100008b;
const int32_t STRING_PLAN_TEXT = 0x0100008c;
const int32_t STRING_PRIVACY_POLICY = 0x0100008d;
const int32_t STRING_PROMPT_TEXT = 0x0100008e;
const int32_t STRING_READ_AND_AGREED = 0x0100008f;
const int32_t STRING_READ_AND_CHECK = 0x01000090;
const int32_t STRING_REASON = 0x01000091;
const int32_t STRING_SCROLL_WIDTH = 0x01000092;
const int32_t STRING_SEARCH_BACK_SIZE_MARGIN = 0x01000093;
const int32_t STRING_SEARCH_BACKGROUND_COLOR = 0x01000094;
const int32_t STRING_SEARCH_DELETE_TITLE = 0x01000095;
const int32_t STRING_SEARCH_DIVIDER_HEIGHT = 0x01000096;
const int32_t STRING_SEARCH_HEIGHT = 0x01000097;
const int32_t STRING_SEARCH_HISTORY = 0x01000098;
const int32_t STRING_SEARCH_HISTORY_DELETE_SIZE = 0x01000099;
const int32_t STRING_SEARCH_HISTORY_FONT_SIZE2 = 0x0100009a;
const int32_t STRING_SEARCH_HISTORY_FONT_SIZE3 = 0x0100009b;
const int32_t STRING_SEARCH_HISTORY_TEXT_PADDING_MARGIN1 = 0x0100009c;
const int32_t STRING_SEARCH_HISTORY_TEXT_PADDING_MARGIN2 = 0x0100009d;
const int32_t STRING_SEARCH_HISTORY_TEXT_PADDING_MARGIN3 = 0x0100009e;
const int32_t STRING_SEARCH_HISTORY_TEXT_PADDING_MARGIN4 = 0x0100009f;
const int32_t STRING_SEARCH_LIST_IMAGE_WIDTH = 0x010000a0;
const int32_t STRING_SEARCH_LIST_TEXT_COLOR = 0x010000a1;
const int32_t STRING_SEARCH_PLACEHOLDER = 0x010000a2;
const int32_t STRING_SEC_PROMPT = 0x010000a3;
const int32_t STRING_SERVICE_AGREEMENT = 0x010000a4;
const int32_t STRING_SERVICES_AND_POLICIES = 0x010000a5;
const int32_t STRING_SHARED_DESC = 0x010000a6;
const int32_t STRING_SOUND_HOUND = 0x010000a7;
...
const int32_t STRING_TEXT_HAPPY = 0x010000ab;
const int32_t STRING_TEXT_LOAD = 0x010000ac;
const int32_t STRING_TEXT_MINE = 0x010000ad;
const int32_t STRING_TEXT_NEW_USER_REGISTRATION = 0x010000ae;
const int32_t STRING_TEXT_RELAXATION = 0x010000af;
const int32_t STRING_TEXT_SHOPPING = 0x010000b0;
const int32_t STRING_TEXT_WELCOME = 0x010000b1;
const int32_t STRING_TICKET_ENTRANCE = 0x010000b2;
const int32_t STRING_TICKET_ENTRANCE_DATA_1 = 0x010000b3;
const int32_t STRING_TICKET_ENTRANCE_DATA_2 = 0x010000b4;
const int32_t STRING_TIME_DIFFERENCE_DATA_1 = 0x010000b5;
const int32_t STRING_TIME_DIFFERENCE_DATA_2 = 0x010000b6;
const int32_t STRING_TITLE_NAME = 0x010000b7;
const int32_t STRING_TRAIN_NUMBER_DATA_1 = 0x010000b8;
const int32_t STRING_TWO_FR = 0x010000b9;
const int32_t STRING_VEHICLE_MODEL = 0x010000ba;
const int32_t STRING_VEHICLE_MODEL_DATA_1 = 0x010000bb;
const int32_t STRING_VEHICLE_MODEL_DATA_2 = 0x010000bc;
const int32_t STRING_VOICE_RECORD_DYNAMIC_EFFECT_APP_NAME = 0x010000bd;
const int32_t STRING_VOICE_RECORD_DYNAMIC_EFFECT_BUTTON = 0x010000be;
const int32_t STRING_VOICE_RECORD_DYNAMIC_EFFECT_COLOR_STACK = 0x010000bf;
const int32_t STRING_VOICE_RECORD_DYNAMIC_EFFECT_FRIEND = 0x010000c0;
const int32_t STRING_VOICE_RECORD_DYNAMIC_EFFECT_HEIGHT_FULL = 0x010000c1;
const int32_t STRING_VOICE_RECORD_DYNAMIC_EFFECT_SEND_MESSAGE = 0x010000c2;
const int32_t STRING_VOICE_RECORD_DYNAMIC_EFFECT_TALK_INFO = 0x010000c3;
const int32_t STRING_VOICE_RECORD_DYNAMIC_EFFECT_TALK_MESSAGE = 0x010000c4;
const int32_t STRING_VOICE_RECORD_DYNAMIC_EFFECT_TALK_MESSAGE_FOUR = 0x010000c5;
const int32_t STRING_VOICE_RECORD_DYNAMIC_EFFECT_TALK_MESSAGE_ONE = 0x010000c6;
const int32_t STRING_VOICE_RECORD_DYNAMIC_EFFECT_TALK_MESSAGE_THR = 0x010000c7;
const int32_t STRING_VOICE_RECORD_DYNAMIC_EFFECT_TALK_MESSAGE_TWO = 0x010000c8;
const int32_t STRING_VOICE_RECORD_DYNAMIC_EFFECT_TOP_FIG = 0x010000c9;
const int32_t STRING_VOICE_RECORD_DYNAMIC_EFFECT_WIDTH_FULL = 0x010000ca;
const int32_t STRING_VOICE_RECORD_DYNAMIC_EFFECT_WIDTH_HALF = 0x010000cb;
const int32_t STRING_VOICE_RECORD_DYNAMIC_EFFECT_WIDTH_NINE = 0x010000cc;
const int32_t STRING_VOTING_COMPONENT_BOTTOM_TEXT_SUFFIX = 0x010000cd;
const int32_t STRING_VOTING_COMPONENT_FIRST_STACK_WIDTH = 0x010000ce;
const int32_t STRING_VOTING_COMPONENT_MID_GAP_MARK_ANCHOR = 0x010000cf;
const int32_t STRING_VOTING_COMPONENT_MID_TEXT_LEFT = 0x010000d0;
const int32_t STRING_VOTING_COMPONENT_MID_TEXT_RIGHT = 0x010000d1;
const int32_t STRING_VOTING_COMPONENT_PARENT_COLUMN_HEIGHT = 0x010000d2;
const int32_t STRING_VOTING_COMPONENT_PARENT_COLUMN_WIDTH = 0x010000d3;
const int32_t STRING_VOTING_COMPONENT_VOTING_THEME_IMAGE_TEXT = 0x010000d4;
const int32_t STRING_VOTING_NOTICE = 0x010000d5;
const int32_t STRING_WHOLE_COURSE_DATA_1 = 0x010000d6;
const int32_t STRING_WHOLE_COURSE_DATA_2 = 0x010000d7;
...
const int32_t MEDIA_ADD = 0x01000140;
const int32_t MEDIA_APP_ICON = 0x01000000;
const int32_t MEDIA_BRIGHT = 0x01000132;
const int32_t MEDIA_BRIGHTNESS_FILLED = 0x01000128;
const int32_t MEDIA_CANCEL = 0x01000143;
const int32_t MEDIA_CHANGE = 0x01000146;
const int32_t MEDIA_CHANGEBACK = 0x01000147;
const int32_t MEDIA_CLOCK = 0x01000133;
const int32_t MEDIA_CLOCK_BG = 0x01000137;
const int32_t MEDIA_CLOCK_BG_OUT = 0x01000130;
const int32_t MEDIA_CLOCK_BLUE = 0x0100013c;
const int32_t MEDIA_DOT = 0x0100013d;
const int32_t MEDIA_ENLARGE = 0x0100013b;
const int32_t MEDIA_HOURS = 0x0100012b;
const int32_t MEDIA_IC_PUBLIC_BACK = 0x01000127;
const int32_t MEDIA_IC_PUBLIC_DELETE_FILLED = 0x0100013a;
const int32_t MEDIA_IC_PUBLIC_DESELECT_ALL = 0x0100013e;
const int32_t MEDIA_ICON = 0x010000da;
const int32_t MEDIA_LIST = 0x01000145;
const int32_t MEDIA_MINUTES = 0x01000142;
const int32_t MEDIA_OK = 0x0100012f;
const int32_t MEDIA_PAUSE = 0x01000129;
const int32_t MEDIA_RESET = 0x0100013f;
const int32_t MEDIA_RESETCCC = 0x0100012c;
const int32_t MEDIA_SECONDS = 0x01000131;
const int32_t MEDIA_SETTINGS = 0x0100012a;
const int32_t MEDIA_SETTINGS_BLUE = 0x01000136;
const int32_t MEDIA_START = 0x0100012e;
const int32_t MEDIA_SUNNY = 0x01000135;
const int32_t MEDIA_TEST = 0x01000144;
const int32_t MEDIA_TIMER = 0x01000139;
const int32_t MEDIA_TIMER_BLUE = 0x01000138;
const int32_t MEDIA_WORLDCLOCK = 0x01000141;
const int32_t MEDIA_WORLDCLOCK_BLUE = 0x0100012d;
